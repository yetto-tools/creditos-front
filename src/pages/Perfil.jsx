    ...
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto flex flex-col justify-start items-center">
        ...
        <div className="mb-8 text-center md:text-left w-full">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 flex justify-center md:justify-start items-center space-x-2">
        ...
        {message && (
          <div
            className={`mb-6 p-4 rounded-lg flex items-center space-x-3 w-full max-w-lg ${
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          ...
          {/* Información General */}
          <article className="bg-white shadow-sm rounded-lg p-4">
          ...
          {/* Cambiar Contraseña */}
          <article className="bg-white shadow-sm rounded-lg p-4 md:col-span-2 lg:col-span-2">
          ...
          {/* Editar Perfil / Detalles */}
          <article className="bg-white shadow-sm rounded-lg p-4 md:col-span-2 lg:col-span-1">
